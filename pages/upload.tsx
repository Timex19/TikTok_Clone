...
const Upload = () => {
    ...
    const uploadVideo = async (e: any) => {
        ...
        const fileTypes = ['video/mp4', 'video/wem', 'video/ogg'];
                    ...
                    <div className="border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center items-center outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:border-red-300 hover:bg-gray-100">
                        {isLoading ? (
                            ...
                            <div>
                                {videoAsset ? (
                                    <div>
                                        <video src={videoAsset?.url} loop controls className="rounded-xl h-[430px] w-[250px] mt-2 bg-black">
                                ...
                                {wrongFileType && (
                                    <p className="text-center text-xl text-red-400 font-semibold mb-4 w-[250px]">
